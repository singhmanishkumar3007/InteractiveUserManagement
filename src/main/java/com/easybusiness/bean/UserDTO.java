...
public class UserDTO implements Serializable {
	...
	return "UserDTO [id=" + id + ", userName=" + userName + ", firstName=" + firstName + ", fromDate=" + fromDate
		...
		+ ", permAddr=" + permAddr + ", userImg=" + Arrays.toString(userImg) + ", modifiedBy=" + modifiedBy
		+ ", modifiedOn=" + modifiedOn + ", state=" + state + ", city=" + city + ", country=" + country
		+ ", zip=" + zip + ", fatherName=" + fatherName + ", spouseName=" + spouseName + ", passport="
		+ passport + ", location=" + location + ", unitId=" + unitId + "]";
    }

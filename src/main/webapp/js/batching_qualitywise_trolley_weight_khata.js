...
///////////////////////////////////////////live table//////////////////////////////////
 ...
 var datString='issue_date='+issue_date;
	...
	$.ajax({
      type: "POST",
      url: "batching_qualitywise_trolley_weight_khata_table.php",
      data: datString,
...
XfakeScrollablePanel.onscroll = function (e) {
	...
	$("#details td").click(function () 
		...
		var quality= $(this).closest('tr').find('td:eq(7)').text();
...
var net_weight=$('#net_weight').val();
	...
	var datString='issue_date='+issue_date+'&spell='+spell+'&quality='+quality+'&trolley_no='+trolley_no+'&gross_weight='+gross_weight+'&net_weight='+net_weight;
	
	$.ajax({
      type: "POST",
      url: "batching_qualitywise_trolley_weight_khata_save.php",
      data: datString,
      success: function(data) {        
...
var net_weight=$('#net_weight').val();
	...
	var datString='rec_id='+rec_id+'&quality='+quality+'&trolley_no='+trolley_no+'&gross_weight='+gross_weight+'&net_weight='+net_weight;
	
	$.ajax({
      type: "POST",
      url: "batching_qualitywise_trolley_weight_khata_edit.php",
      data: datString,
      success: function(data) {        
...
$.ajax({
      type: "POST",
      url: "batching_qualitywise_trolley_weight_khata_datewise.php",
      data: datString,
      success: function(data) {
...
$("#load:hidden").fadeIn("slow");
	...
	var datString = 'issue_date='+issue_date+'&spell='+spell; 
	 //alert(datString); 			 
	  ...
	  $.ajax({
      type: "POST",
      url: "batching_qualitywise_trolley_weight_khata_datewise_onselect.php",
      data: datString,
      success: function(data) { 
		$("#load").hide();
		$("#details").html(data);
...
$.ajax({
      type: "POST",
      url: "batching_qualitywise_trolley_weight_khata_delete.php",
      data: datString,
      success: function(data) {

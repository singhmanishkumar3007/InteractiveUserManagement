...
$('#gross_weight').css("border-color", "").attr('disabled',true);;		
...
///////////////////////////////////////////live table//////////////////////////////////
 ...
 var datString='issue_date='+issue_date;
	$.ajax({
      type: "POST",
      url: "batching_wastagewise_trolley_weight_khata_table.php",
      data: datString,
...
XfakeScrollablePanel.onscroll = function (e) {
	...
	$("#details td").click(function () 
		...
		var trolley_no= $(this).closest('tr').find('td:eq(1)').text();
		var gross_weight= $(this).closest('tr').find('td:eq(2)').text();	
		var trolley_weight= $(this).closest('tr').find('td:eq(3)').text();
		var net_weight= $(this).closest('tr').find('td:eq(4)').text();		
		var issue_date= $(this).closest('tr').find('td:eq(5)').text();		
		var spell= $(this).closest('tr').find('td:eq(6)').text();
		var wastage= $(this).closest('tr').find('td:eq(7)').text();
...
$.ajax({
      type: "POST",
      url: "batching_qualitywise_trolley_weight_khata_tarewt.php",
	  data: datString,
      success: function(data) {
	  $("#load").hide();
...
var net_weight=$('#net_weight').val();
	...
	var datString='issue_date='+issue_date+'&spell='+spell+'&wastage='+wastage+'&trolley_no='+trolley_no+'&gross_weight='+gross_weight+'&net_weight='+net_weight;
	
	$.ajax({
      type: "POST",
      url: "batching_wastagewise_trolley_weight_khata_save.php",
      data: datString,
      success: function(data) {        
...
var net_weight=$('#net_weight').val();
	...
	var datString='rec_id='+rec_id+'&wastage='+wastage+'&trolley_no='+trolley_no+'&gross_weight='+gross_weight+'&net_weight='+net_weight;
	
	$.ajax({
      type: "POST",
      url: "batching_wastagewise_trolley_weight_khata_edit.php",
      data: datString,
      success: function(data) {        
...
$.ajax({
      type: "POST",
      url: "batching_wastagewise_trolley_weight_khata_datewise.php",
      data: datString,
      success: function(data) {
...
$("#load:hidden").fadeIn("slow");
   ...
   var issue_date= $(this).closest('tr').find('td:eq(0)').text();
	...
	var datString = 'issue_date='+issue_date+'&spell='+spell; 
	  ...
	  $.ajax({
      type: "POST",
      url: "batching_wastagewise_trolley_weight_khata_datewise_onselect.php",
      data: datString,
      success: function(data) { 
		$("#load").hide();
		$("#details").html(data);
...
$.ajax({
      type: "POST",
      url: "batching_wastagewise_trolley_weight_khata_delete.php",
      data: datString,
      success: function(data) {

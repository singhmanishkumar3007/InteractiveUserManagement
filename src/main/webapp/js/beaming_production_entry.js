...
///////////////////////////////////////////live table//////////////////////////////////
 ...
 var datString='issue_date='+issue_date;
	$.ajax({
      type: "POST",
      url: "beaming_production_entry_table.php",
      data: datString,
      success: function(data) {        
...
XfakeScrollablePanel.onscroll = function (e) {
	...
	$("#details td").click(function () 
		...
		var quality= $(this).closest('tr').find('td:eq(6)').text();	
		var production= $(this).closest('tr').find('td:eq(7)').text();
...
if(production=='')
	...
	var datString='issue_date='+issue_date+'&spell='+spell+'&eb_no='+eb_no+'&quality='+quality+'&production='+production+'&idle_hours='+idle_hours+'&working_hours='+working_hours;

	
	$.ajax({
      type: "POST",
      url: "beaming_production_entry_data_save.php",
      data: datString,
      success: function(data) {        
...
//alert(datString);
	...
	$.ajax({
      type: "POST",
      url: "beaming_production_entry_edit.php",
      data: datString,
      success: function(data) {        
...
$.ajax({
      type: "POST",
      url: "beaming_production_entry_datewise.php",
      data: datString,
      success: function(data) {
...
/////////create div forajax loading	
	...
	var datString = 'issue_date='+issue_date+'&spell='+spell; 
	 //alert(datString); 			 
	  ...
	  $.ajax({
      type: "POST",
      url: "beaming_production_entry_datewise_onselect.php",
      data: datString,
      success: function(data) { 
		$("#load").hide();
		$("#details").html(data);
...
$.ajax({
      type: "POST",
      url: "beaming_production_entry_delete.php",
      data: datString,
      success: function(data) {

...
var issue_date=$('#issue_date').val();
	...
	$.ajax({
      type: "POST",
      url: "herackle_register_live_table.php",
      data: datString,
...
if(idle_hours=='')
	...
	$.ajax({
      type: "POST",
      url: "herackle_register_data_save.php",
      data: datString,
      success: function(data) {        
...
if(idle_hours=='')
	...
	$.ajax({
      type: "POST",
      url: "herackle_register_edit.php",
      data: datString,
      success: function(data) {        
...
$.ajax({
      type: "POST",
      url: "herackle_register_datewise.php",
      data: datString,
      success: function(data) {
...
/////////create div forajax loading	
	...
	var datString = 'spell='+spell+'&issue_date='+issue_date; 
	  ...
	  $.ajax({
      type: "POST",
      url: "herackle_register_datewise_onselect.php",
      data: datString,
      success: function(data) { 
		$("#load").hide();
		$("#details").html(data);
...
$.ajax({
      type: "POST",
      url: "herackle_register_delete.php",
      data: datString,
      success: function(data) {

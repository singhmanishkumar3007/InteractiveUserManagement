...
///////////////////////table///////////////////
	...
	$.ajax({
      type: "POST",
      url: "lapping_register_live_table.php",
      data: datString,
...
XfakeScrollablePanel.onscroll = function (e) {
	...
	$("#details td").click(function () 
		...
		var cuts= $(this).closest('tr').find('td:eq(8)').text();	
		var remarks= $(this).closest('tr').find('td:eq(9)').text();			
		var rec_id= $(this).closest('tr').find('td:eq(10)').text();
		var idle_hours= $(this).closest('tr').find('td:eq(11)').text();
...
if(idle_hours=='')
	...
	var datString='issue_date='+issue_date+'&machine_no='+machine_no+'&operator_eb_no='+operator_eb_no+'&helper_eb_no='+helper_eb_no+'&cuts='+cuts+'&remarks='+remarks+'&spell='+spell+'&idle_hours='+idle_hours;

	
	$.ajax({
      type: "POST",
      url: "lapping_register_data_save.php",
      data: datString,
      success: function(data) {        
...
var idle_hours=$('#idle_hours').val();
	...
	var datString='operator_eb_no='+operator_eb_no+'&helper_eb_no='+helper_eb_no+'&cuts='+cuts+'&remarks='+remarks+'&rec_id='+rec_id+'&idle_hours='+idle_hours;
		//alert(datString);
	$.ajax({
      type: "POST",
      url: "lapping_register_edit.php",
      data: datString,
      success: function(data) {        
...
$.ajax({
      type: "POST",
      url: "lapping_register_datewise.php",
      data: datString,
      success: function(data) {
...
/////////create div forajax loading	
	...
	var datString = 'spell='+spell+'&issue_date='+issue_date; 
	  ...
	  $.ajax({
      type: "POST",
      url: "lapping_register_datewise_onselect.php",
      data: datString,
      success: function(data) { 
		$("#load").hide();
		$("#details").html(data);
...
$.ajax({
      type: "POST",
      url: "lapping_register_delete.php",
      data: datString,
      success: function(data) {

...
///////////////////////////////////////////live table//////////////////////////////////
 ...
 var datString='issue_date='+issue_date;
	$.ajax({
      type: "POST",
      url: "press_production_register_live_table.php",
      data: datString,
      success: function(data) {        
...
XfakeScrollablePanel.onscroll = function (e) {
	...
	$("#details td").click(function () 
		...
		var prod= $(this).closest('tr').find('td:eq(5)').text();	
...
///////////////////////////////////////////RESET END//////////////////////////////////////
//////////////////////////////////////////bales to mton////////////////////
$('#prod').bind('input', function()
{
var prod=$('#prod').val();
prod=parseFloat(prod);
var m_ton=((prod)*0.334176);
...
if(prod=='')
	{
		...
		$('#prod').focus().css("border-color", "red");
		return false;
	}
...
if(metric_ton=='')
	...
	var datString='issue_date='+issue_date+'&spell='+spell+'&eb_no='+eb_no+'&quality='+quality+'&prod='+prod+'&idle_hours_all='+idle_hours_all+'&idle_hours_each='+idle_hours_each+'&working_hours='+working_hours+'&metric_ton='+metric_ton;

	$.ajax({
      type: "POST",
      url: "press_production_register_data_save.php",
      data: datString,
      success: function(data) {        
...
var metric_ton=$('#metric_ton').val();
	...
	var datString='eb_no='+eb_no+'&quality='+quality+'&prod='+prod+'&idle_hours_each='+idle_hours_each+'&metric_ton='+metric_ton+'&rec_id='+rec_id;
	
	$.ajax({
      type: "POST",
      url: "press_production_register_edit.php",
      data: datString,
      success: function(data) {        
...
$.ajax({
      type: "POST",
      url: "press_production_register_datewise.php",
      data: datString,
      success: function(data) {
...
/////////create div forajax loading		
	...
	var datString = 'issue_date='+issue_date+'&spell='+spell; 
	  ...
	  $.ajax({
      type: "POST",
      url: "press_production_register_datewise_onselect.php",
      data: datString,
      success: function(data) { 
		$("#load").hide();
		$("#details").html(data);
...
$.ajax({
      type: "POST",
      url: "press_production_register_delete.php",
      data: datString,
      success: function(data) {

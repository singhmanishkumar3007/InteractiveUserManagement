...
///////////////////////////////////////////live table//////////////////////////////////
 ...
 var datString='issue_date='+issue_date;
	$.ajax({
      type: "POST",
      url: "weaving_production_entry_live_table.php",
      data: datString,
      success: function(data) {        
...
XfakeScrollablePanel.onscroll = function (e) {
	...
	$("#details td").click(function () 
		...
		var cuts= $(this).closest('tr').find('td:eq(6)').text();
		var tonnage= $(this).closest('tr').find('td:eq(7)').text();
...
if(tonnage=='')
	{
		alert("Please Enter Tonnage !");
			$('#tonnage').focus().css("border-color", "red");
		return false;
	}

	var datString='issue_date='+issue_date+'&shift='+shift+'&working_hours='+working_hours+'&quality_code='+quality_code+'&cuts='+cuts+'&tonnage='+tonnage;
	
	$.ajax({
      type: "POST",
      url: "weaving_production_entry_data_save.php",
      data: datString,
      success: function(data) {        
...
if(tonnage=='')
	...
	var datString='working_hours='+working_hours+'&quality_code='+quality_code+'&cuts='+cuts+'&tonnage='+tonnage+'&rec_id='+rec_id;
	
	
	$.ajax({
      type: "POST",
      url: "weaving_production_entry_edit.php",
      data: datString,
      success: function(data) {        
...
$.ajax({
      type: "POST",
      url: "weaving_production_entry_datewise.php",
      data: datString,
      success: function(data) {
...
/////////create div forajax loading	
	...
	var datString = 'issue_date='+issue_date+'&shift='+shift; 
	  ...
	  $.ajax({
      type: "POST",
      url: "weaving_production_entry_datewise_onselect.php",
      data: datString,
      success: function(data) { 
		$("#load").hide();
...
$.ajax({
      type: "POST",
      url: "weaving_production_entry_delete.php",
      data: datString,
      success: function(data) {

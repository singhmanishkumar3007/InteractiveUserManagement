...
$('#eb_no').focus();
$('#idle_hours').val('').css("border-color", "").attr('disabled',false);	
...
///////////////////////////////////////////live table//////////////////////////////////
 ...
 var datString='issue_date='+issue_date;
	$.ajax({
      type: "POST",
      url: "winding_idle_hours_entry_live_table.php",
      data: datString,
      success: function(data) {        
...
XfakeScrollablePanel.onscroll = function (e) {
	...
	$("#details td").click(function () 
		...
		var eb_no= $(this).closest('tr').find('td:eq(3)').text();	
		var idle_hours= $(this).closest('tr').find('td:eq(4)').text();			
...
if(idle_hours=='')
	{
		alert("Please Idle Hours !");
			$('#idle_hours').focus().css("border-color", "red");
		return false;
	}	


	var datString='issue_date='+issue_date+'&spell='+spell+'&eb_no='+eb_no+'&idle_hours='+idle_hours;

	
	$.ajax({
      type: "POST",
      url: "winding_idle_hours_entry_data_save.php",
      data: datString,
      success: function(data) {        
...
if(production=='')
	...
	var datString='eb_no='+eb_no+'&idle_hours='+idle_hours+'&rec_id='+rec_id+'&issue_date='+issue_date+'&spell='+spell;
//alert(datString);
	
	$.ajax({
      type: "POST",
      url: "winding_idle_hours_entry_edit.php",
      data: datString,
      success: function(data) {        
...
$.ajax({
      type: "POST",
      url: "winding_idle_hours_entry_datewise.php",
      data: datString,
      success: function(data) {
...
/////////create div forajax loading	
	...
	var datString = 'issue_date='+issue_date+'&spell='+spell; 
	  ...
	  $.ajax({
      type: "POST",
      url: " winding_idle_hours_entry_datewise_onselect.php",
      data: datString,
      success: function(data) { 
		$("#load").hide();
		$("#details").html(data);
...
$.ajax({
      type: "POST",
      url: "winding_idle_hours_entry_delete.php",
      data: datString,
      success: function(data) {

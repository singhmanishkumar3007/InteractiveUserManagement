   ...
   <body>
	...
	<header class="color destopmenu">
      ...
      <main class="body-contant">
         <div class="container">
            <!-- container-->
           <s:form name="editPersonalDetails" action="editpersonaldetails"
                           ...
                           <div class="row">
                              <div class="col-sm-6">
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" id="editName" name="editName" value="<c:out value="${userDetailsDTO.firstName}"/> ">
                                    </div>
                                 </div>
                                   <div class="form-group row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" id="editAddress" name="editAddress" value="<c:out value="${userDetailsDTO.permAddr}"/>">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" id="editEmail" name="editEmail" value="<c:out value="${userDetailsDTO.email}"/>">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" id="editMobile" name="editMobile" value="<c:out value="${userDetailsDTO.mobile}"/>">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" id="editState" name="editState" value="<c:out value="${userDetailsDTO.state}"/>">
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" id="editCity" name="editCity" value="<c:out value="${userDetailsDTO.city}"/>">
                                    </div>
                                 </div>
                                   <div class="form-group row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                      <input type="text" id="editCountry" name="editCountry" value="<c:out value="${userDetailsDTO.country}"/>">
                                    </div>
                                 </div>
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" id="editLastName" name="editLastName" value="<c:out value="${userDetailsDTO.lastName}"/>">
                                    </div>
                                 </div>
                                  <div class="form-group row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" id="editZip" name="editZip" value="<c:out value="${userDetailsDTO.zip}"/>">
                                    </div>
                                 </div>
                                   <div class="form-group row">
                                    <div class="col-sm-4">
                                    <label>Date of Birth(e.g. 26-JUN-1999)<span>*</span></label>
                                    </div>
                                    <div class="col-sm-8">
                                         <input type="text" id="editDOB" name="editDOB" value="<c:out value="${formattedDate}"/>">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" id="editFather" name="editFather" value="<c:out value="${userDetailsDTO.fatherName}"/>">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" id="editSpouse" name="editSpouse" value="<c:out value="${userDetailsDTO.spouseName}"/>">
                                    </div>
                                 </div>
                                  <div class="form-group row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" id="editPassport" name="editPassport" value="<c:out value="${userDetailsDTO.passport}"/>">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <div class="col-sm-4">
            ...
            <div class="all-btn-style">
                 <button class="sh-input">Reset</button>
                  <button class="sh-input">Submit</button>
            ...
            <s:if test="showResult=='yes'">
					...
					<div id="result">
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-10">User Details updated successfully</div>
							</div>
						</div>
						<hr>
